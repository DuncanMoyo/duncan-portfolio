      ...
      <div className="md:flex md:justify-between md:gap-16 mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-7">
            Again, This is my demo for a portfolio page that i have created. I
            hope you like it. I incorporated a lot of tailwind-CSS and it was
            fun. I can build more like this if needed :)
          </p>
        </motion.div>
        <div className="mt-16 md:mt-0">
          {isAboveMediumScreens ? (
            <div
             ...
             before:-left-10 before:w-full before:h-full before:border-2 before:border-blue before:z-[-1] "
            >
              <img
                alt="skills"

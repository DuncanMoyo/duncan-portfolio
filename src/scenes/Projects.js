  ...
  return (
    <motion.div variants={projectVariant} className='relative' >
      <div className={overlayStyles} >
        ...
        <p className="mt-7" >
          Lorem ipsum cheeky gilgamesh thrones of games. Ragnarok Thor place queit a ultron of age theory bang big the</p>
      </div>
    ...
    <section id="projects" className="pt-48 pb-48">
      ...
      >
        ...
        <p className="mt-10 mb-10">
          ...
          fames odio in at. What are you gonna do when the rent is due?
        </p>
      </motion.div>
